...
var onEvmLogTrigger = (runtime2, payload) => {
  ...
  const envelope = reconcileChainlinkApiGuardLog(runtime2, runtime2.config, payload);
  return safeJson(buildEnvelope({
    ...envelope,
...
var onCronTrigger = (runtime2, payload) => {
  ...
  const envelope = runChainlinkApiGuardFlow(runtime2, runtime2.config, "cron", {});
  return safeJson(buildEnvelope({
    ...envelope,
